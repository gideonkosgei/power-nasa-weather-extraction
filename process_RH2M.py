...
class Process:
    ...
    def __init__(self):
        ...
        self.request_template = r"https://power.larc.nasa.gov/api/temporal/daily/point?parameters=T2M,RH2M,T2MDEW,T2MWET,TS,T2M_RANGE,T2M_MAX,T2M_MIN&community=AG&longitude={longitude}&latitude={latitude}&start={start}&end={end}&format=JSON"
    ...
    def download_function(self, collection):
        ...
        try:
            ...
            if connection.is_connected():
                ...
                t2m_max_records = response['properties']['parameter']['RH2M']
                ...
                for t2m_max_date in t2m_max_dates:
                    ...
                    sql_insert_query = "insert into RH2M(date_value,longitude,latitude,RH2M) values (\'{date_value}\',{longitude},{latitude},{T2M_MAX})".format(

    ...
    def download_function(self, collection):
        ...
        try:
            ...
            if connection.is_connected():
                ...
                t2m_max_records = response['properties']['parameter']['T2M_MIN']
                ...
                for t2m_max_date in t2m_max_dates:
                    ...
                    sql_insert_query = "insert into T2M_MIN(date_value,longitude,latitude,T2M_MIN) values (\'{date_value}\',{longitude},{latitude},{T2M_MIN})".format(
                        date_value=t2m_max_date_formatted_str, longitude=longitude, latitude=latitude,
                        T2M_MIN=t2m_max_value)
